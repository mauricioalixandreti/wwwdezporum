! function(t, e) {
    ...
    var V = function() {
        try {
            return Date.prototype.toJSON && null === new Date(0 / 0).toJSON() && -1 !== new Date(q).toJSON().indexOf(K) && Date.prototype.toJSON.call({
                toISOString: function() {
                    return !0
                }
            })
    ...
    V || (Date.prototype.toJSON = function(t) {
        var r = Object(this),
            n = A.ToPrimitive(r);
    ...
    var W = 1e15 === Date.parse("+033658-09-27T01:46:40.000Z"),
    ...
    (!Date.parse || et || tt || !W) && (Date = function(t) {
        ...
        return e.now = t.now, e.UTC = t.UTC, e.prototype = t.prototype, e.prototype.constructor = e, e.parse = function(e) {
            ...
            if (i) {
                var a, l = Number(i[1]),
                    ...
                    v = Number(i[10] || 0),
                    d = Number(i[11] || 0);
                return (f > 0 || p > 0 || h > 0 ? 24 : 25) > s && 60 > f && 60 > p && 1e3 > h && u > -1 && 12 > u && 24 > v && 60 > d && c > -1 && c < r(l, u + 1) - r(l, u) && (a = 60 * (24 * (r(l, u) + c) + s + v * y), a = 1e3 * (60 * (a + f + d * y) + p) + h, g && (a = n(a)), a >= -864e13 && 864e13 >= a) ? a : 0 / 0
            }
    ...
    var rt = a.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
        nt = {
            base: 1e7,
            size: 6,
            data: [0, 0, 0, 0, 0, 0],
            multiply: function(t, e) {
                for (var r = -1, n = e; ++r < nt.size;) n += t * nt.data[r], nt.data[r] = n % nt.base, n = Math.floor(n / nt.base)
            },
            divide: function(t) {
                for (var e = nt.size, r = 0; --e >= 0;) r += nt.data[e], nt.data[e] = Math.floor(r / t), r = r % t * nt.base
            },
            numToString: function() {
                for (var t = nt.size, e = ""; --t >= 0;)
                    if ("" !== e || 0 === t || 0 !== nt.data[t]) {
                        var r = String(nt.data[t]);
                        "" === e ? e = r : e += "0000000".slice(0, 7 - r.length) + r
                    }
                return e
            },
            pow: function yt(t, e, r) {
                return 0 === e ? r : e % 2 === 1 ? yt(t, e - 1, r * t) : yt(t * t, e / 2, r)
            },
            log: function(t) {
    ...
    E(a, {
        toFixed: function(t) {
            ...
            if (n = "", 0 > r && (n = "-", r = -r), o = "0", r > 1e-21)
                if (i = nt.log(r * nt.pow(2, 69, 1)) - 69, a = 0 > i ? r * nt.pow(2, -i, 1) : r / nt.pow(2, i, 1), a *= 4503599627370496, i = 52 - i, i > 0) {
                    for (nt.multiply(0, a), l = e; l >= 7;) nt.multiply(1e7, 0), l -= 7;
                    for (nt.multiply(nt.pow(10, l, 1), 0), l = i - 1; l >= 23;) nt.divide(1 << 23), l -= 23;
                    nt.divide(1 << l), nt.multiply(1, 1), nt.divide(2), o = nt.numToString()
                } else nt.multiply(0, a), nt.multiply(1 << -i, 0), o = nt.numToString() + "0.00000000000000000000".slice(2, 2 + e);
    ...
    2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? ! function() {
        ...
        i.split = function(e, r) {
            ...
            if (!m(e)) return ot.call(this, e, r);
            var o, i, a, l, u = [],
                s = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.extended ? "x" : "") + (e.sticky ? "y" : ""),
                f = 0,
                p = new RegExp(e.source, s + "g");
            n += "", t || (o = new RegExp("^" + p.source + "$(?!\\s)", s));
            var h = "undefined" == typeof r ? -1 >>> 0 : A.ToUint32(r);
            for (i = p.exec(n); i && (a = i.index + i[0].length, !(a > f && (u.push(n.slice(f, i.index)), !t && i.length > 1 && i[0].replace(o, function() {
                    for (var t = 1; t < arguments.length - 2; t++) "undefined" == typeof arguments[t] && (i[t] = void 0)
                }), i.length > 1 && i.index < n.length && c.apply(u, i.slice(1)), l = i[0].length, f = a, u.length >= h)));) p.lastIndex === i.index && p.lastIndex++, i = p.exec(n);
            return f === n.length ? (l || !p.test("")) && u.push("") : u.push(n.slice(f)), u.length > h ? u.slice(0, h) : u
        }
    }() : "0".split(void 0, 0).length && (i.split = function(t, e) {
        return "undefined" == typeof t && 0 === e ? [] : ot.call(this, t, e)
    });
    var it = i.replace,
        at = function() {
            var t = [];
    ...
    at || (i.replace = function(t, r) {
        ...
        if (n && o) {
            ...
            return it.call(this, t, i)
        }
        return it.call(this, t, r)
    });
    var lt = i.substr,
        ut = "".substr && "b" !== "0b".substr(-1);
    E(i, {
        substr: function(t, e) {
            var r = t;
            return 0 > t && (r = Math.max(this.length + t, 0)), lt.call(this, r, e)
        }
    }, ut);
    var ct = "	\n\f\r   ᠎             　\u2028\u2029\ufeff",
        st = "​",
        ...
        pt = new RegExp("^" + ft + ft + "*"),
        ht = new RegExp(ft + ft + "*$"),
        gt = i.trim && (ct.trim() || !st.trim());
    E(i, {
        trim: function() {
            if ("undefined" == typeof this || null === this) throw new TypeError("can't convert " + this + " to object");
            return String(this).replace(pt, "").replace(ht, "")
        }
    }, gt), (8 !== parseInt(ct + "08") || 22 !== parseInt(ct + "0x16")) && (parseInt = function(t) {
        var e = /^0[xX]/;
        return function(r, n) {
            var o = String(r).trim(),
                i = Number(n) || (e.test(o) ? 16 : 10);
            return t(o, i)
        }
    }(parseInt))
}),
            ...
            if ("bug-string-char-index" == t) e = "a" != "a" [0];
                ...
                if ("json-stringify" == t) {
                    ...
                    if (s) {
                        ...
                        try {
                            s = "0" === u(0) && "0" === u(new a) && '""' == u(new l) && u(b) === v && u(v) === v && u() === v && "1" === u(r) && "[1]" == u([r]) && "[null]" == u([v]) && "null" == u(null) && "[null,null,null]" == u([v, b, null]) && u({
                                a: [r, !0, !1, null, "\x00\b\n\f\r	"]
            ...
            if ((g = d.hasOwnProperty) || (g = function(t) {
                ...
                var M = {
                    ...
                    J = function(t, e, r, n, o, i, a) {
                        var l, u, c, s, p, h, d, m, w, T, N, A, M, D, _, k;
                        try {
                            l = e[t]
                        } catch (P) {}
                        if ("object" == typeof l && l)
                            ...
                            if (I) {
                                ...
                                p = 1 + p - I(c, s), h = (l % 864e5 + 864e5) % 864e5, d = E(h / 36e5) % 24, m = E(h / 6e4) % 60, w = E(h / 1e3) % 60, T = h % 1e3
                            } else c = l.getUTCFullYear(), s = l.getUTCMonth(), p = l.getUTCDate(), d = l.getUTCHours(), m = l.getUTCMinutes(), w = l.getUTCSeconds(), T = l.getUTCMilliseconds();
                            l = (0 >= c || c >= 1e4 ? (0 > c ? "-" : "+") + U(6, 0 > c ? -c : c) : U(4, c)) + "-" + U(2, s + 1) + "-" + U(2, p) + "T" + U(2, d) + ":" + U(2, m) + ":" + U(2, w) + "." + U(3, T) + "Z"
                        } else l = null;
                        ...
                        if ("object" == typeof l) {
                            ...
                            if (a.push(l), N = [], _ = i, i += o, u == x) {
                                for (M = 0, D = l.length; D > M; M++) A = J(M, l, r, n, o, i, a), N.push(A === v ? "null" : A);
                                k = N.length ? o ? "[\n" + i + N.join(",\n" + i) + "\n" + _ + "]" : "[" + N.join(",") + "]" : "[]"
